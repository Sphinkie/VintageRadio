...
- [x] 1x LED Jaune (pour le statut ON). _Ref: L0_ 
...
- [x] 3x LEDs oranges (pour les Modes). Prévoir 2 à 3 cd (20 à 30 lumen). _Ref: L3 L4 L5_  
...
- [x] 2x LEDs E10 (Eclairage tuning). _Ref: L20 L21_   
...
- [x] 4x PushButton (Year / Genre / Beat / Bluetooth). _Ref: B1 B2 B3 B4_  
...
- [x] 1x micro PushButton (Reset database) - En face arrière. _Ref: SW1_  
  <img src="images/PUSH_ResetDB.png" width="150" alt="PushButton Reset DB">
  
- [x] 1x Résistance 20kΩ pull-up. _Ref: R31_

- [x] 1x Switch Button (Local files/DLNA) - En face arrière. _Ref: SW2_  
  <img src="images/SW_LOCAL.png" width="150" alt="Switch Local/DLNA">
  
- [x] 1x Résistance 20kΩ pull-up. _Ref: R32_

- [x] 1x Power Button (incl. LED) - En face arrière. Bouton 16mm chrome, anneau LED bleue. _Ref: SW3_  
  <img src="images/SW_POWER.png" width="150" alt="Power Button">
  
- [x] 1x Résistance 120Ω (LED ring bleue, sous 5v — Vf=3.2v, 15mA). _Ref: R33_
